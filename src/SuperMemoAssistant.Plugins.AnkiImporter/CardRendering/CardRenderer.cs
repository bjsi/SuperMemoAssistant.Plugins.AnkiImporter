...
using SuperMemoAssistant.Plugins.AnkiImporter.CardRendering.FieldHandlers;
...
namespace SuperMemoAssistant.Plugins.AnkiImporter.CardRendering
{
  ...
  public class CardRenderer
  {
    ...
    public CardRenderer(Card Card)
    {
      ...
      this.Card = Card;
      var Config = Svc<AnkiImporterPlugin>.Plugin.Config;
      CollectionPath = Config.AnkiCollectionDB;
      MediaPath = Config.AnkiCollectionMediaDir;
    ...
    public CardRenderer(Card card, string collectionPath, string mediaPath)
    {
